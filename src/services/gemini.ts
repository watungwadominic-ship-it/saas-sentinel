    ...
    config: {
      ...
      responseSchema: {
        ...
        properties: {
          ...
          image_url: { type: Type.STRING, description: "A high-quality Unsplash image URL relevant to the SaaS/AI topic. Format: https://images.unsplash.com/photo-[ID]?auto=format&fit=crop&q=80&w=1200&h=630" }
        },
